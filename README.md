...
- [ ] First-class support for external formats
   ...
   - [ ] Phase 1: Support identifying external modules (eg typescript) https://github.com/nodejs/node/pull/49704
   - [ ] Phase 2: Support guided-remediation via package manager search (eg `npm search … typescript`)
   - [ ] Phase 3: Automatically set up configuration to signal node of the available module translators
