...
- [ ] Provide a way to register loaders without a command-line flag, for example via a `"loaders"` field in `package.json`. https://github.com/nodejs/loaders/issues/98
